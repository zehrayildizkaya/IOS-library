...
class Okunanlar extends StatefulWidget {
  const Okunanlar({Key? key}) : super(key: key);

  @override
  State<Okunanlar> createState() => _OkunanlarState();
}

class _OkunanlarState extends State<Okunanlar> {
  @override
