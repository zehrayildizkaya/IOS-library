...
class Okunacak extends StatefulWidget {
  const Okunacak({Key? key}) : super(key: key);

  @override
  State<Okunacak> createState() => _OkunacakState();
}

class _OkunacakState extends State<Okunacak> {
  @override
